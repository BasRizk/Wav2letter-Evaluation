...
int main(int argc, char** argv) {
  ...
  /* ===================== Test ===================== */
  TestMeters meters;
  std::ofstream evalLogFIle;
  evalLogFIle.open("test_log.txt");
  evalLogFIle << "elapsed_inf" <<  ",";
  evalLogFIle << "elapsed_em_save" << ",";
  evalLogFIle << "sampleId" << "\n";
  ...
  for (auto& sample : *ds) {
    ...
    auto finish_inf = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> elapsed_inf = finish_inf - start_inf;
    ...
    auto finish_em_save = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> elapsed_em_save = finish_em_save - start_inf;

    std::cout << "Elapsed inf time: " << elapsed_inf.count() << " s\n";
    std::cout << "Elapsed emission save time: " << elapsed_em_save.count() << " s\n";
    std::cout << "Sample: " << sampleId << std::endl; 
    evalLogFIle << elapsed_inf.count() <<  ",";
    evalLogFIle << elapsed_em_save.count() << ",";
    evalLogFIle << sampleId << "\n";
